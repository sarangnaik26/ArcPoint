...
extension HistoryEntryQuerySortBy
  ...
  QueryBuilder<HistoryEntry, HistoryEntry, QAfterSortBy> sortByDetails() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'details', Sort.asc);
    });
  }

  QueryBuilder<HistoryEntry, HistoryEntry, QAfterSortBy> sortByDetailsDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension HistoryEntryQuerySortThenBy
  ...
  QueryBuilder<HistoryEntry, HistoryEntry, QAfterSortBy> thenByDetails() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'details', Sort.asc);
    });
  }

  QueryBuilder<HistoryEntry, HistoryEntry, QAfterSortBy> thenByDetailsDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'details', Sort.desc);
    });
  }
...
extension HistoryEntryQueryWhereDistinct
  ...
  QueryBuilder<HistoryEntry, HistoryEntry, QDistinct> distinctByDetails(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension HistoryEntryQueryProperty
  ...
  QueryBuilder<HistoryEntry, String, QQueryOperations> detailsProperty() {
    return QueryBuilder.apply(this, (query) {
